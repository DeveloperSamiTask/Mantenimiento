  ...
  useEffect(() => {
    setItems([
      ...
      },
      {
        ...
        visible:
          can('ver informe de suma de tiempo registrado') ||
          can('ver informe diario de tiempo registrado') ||
          can('buscar ordenes de trabajo'),
        links: [
          {
          ...
          {
            label: 'Buscar reporte insumos',
            link: route('insumos.search'),
            active: route().current('insumos.search'),
            visible: can('buscar ordenes de trabajo'), // usa el permiso que ya tienes o crea uno nuevo
          },
        ],
      },
      {
